  ...
  async sharePage(@Param('slug') slug: string, @Res() res: Response) {
    ...
    const html = `
      ...
      <head>
        ...
        <meta property="og:url" content="https://xibarubambouck-com-1z5y.vercel.app/articles/${article.postName}" />
        <meta property="og:type" content="article" />
        <script>
          setTimeout(() => {
            window.location.href = "https://xibarubambouck-com-1z5y.vercel.app/${article.postName}";
          }, 300);
        </script>
      </head>
      <body>
