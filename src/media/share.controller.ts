  ...
  async sharePage(@Param('slug') slug: string, @Res() res: Response) {
    ...
    const html = `
      ...
      <head>
        ...
        <meta property="og:url" content="https://xibarubamback.onrender.com/articles/${article.postName}" />
        <meta property="og:type" content="article" />
        <script>
          setTimeout(() => {
            window.location.href = "https://xibarubamback.onrender.com/articles/${article.postName}";
          }, 300);
        </script>
      </head>
      <body>
